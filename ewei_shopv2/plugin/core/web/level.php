    ...
    protected function post() {
        ...
        if ($_W['ispost']) {
            $data = array(
                ...
                'level' => ($_GPC['level']),
                'goodsids_text' => ($_GPC['goodsids_text']),
            );
            ...
            if (!empty($id)) {
                if ($id == 'default') {
                    $updatecontent = "<br/>等级名称: {$set['levelname']}->{$data['levelname']}"
                            . "<br/>一级佣金比例: {$set['commission1']}->{$data['commission1']}"
                            . "<br/>二级佣金比例: {$set['commission2']}->{$data['commission2']}"
                            . "<br/>三级佣金比例: {$set['commission3']}->{$data['commission3']}";
                    ...
                    $updatecontent = "<br/>等级名称: {$level['levelname']}->{$data['levelname']}"
                            . "<br/>一级佣金比例: {$level['commission1']}->{$data['commission1']}"
                            . "<br/>二级佣金比例: {$level['commission2']}->{$data['commission2']}"
                            . "<br/>三级佣金比例: {$level['commission3']}->{$data['commission3']}";
