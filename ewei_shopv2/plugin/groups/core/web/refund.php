    ...
    function submit() {
        ...
        if ($_W['ispost']) {
            ...
            if ($refundstatus == 0) {
                ...
                /*if ($raid == 0) {
                    $raddress = pdo_fetch('select * from '.tablename('ewei_shop_refund_address').' where isdefault=1 and uniacid=:uniacid limit 1',array(':uniacid'=>$uniacid));
                } else {
