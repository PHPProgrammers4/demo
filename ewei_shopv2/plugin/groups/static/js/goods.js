define(['core','tpl'], function (core, tpl) {
    ...
    modal.init = function (id,is_ladder,more_spec) {
        ...
        $("a.btn-groups").bind("click", function () {
            core.json('groups/goods/goodsCheck', {'id': modal.params.id, type: 'groups',is_ladder:modal.params.is_ladder}, function (postjson) {
        ...
        $("a.btn-fightgroups").bind("click", function () {
            core.json('groups/goods/goodsCheck', {'id': modal.params.id, type: 'groups', fightgroups:1}, function (postjson) {
                if (postjson.status == 1 && postjson.result.ladder.length>0) {
                    // 阶梯团
                    $(".chosenum").css("display","block");
                    $(".layer").css("display","block");
