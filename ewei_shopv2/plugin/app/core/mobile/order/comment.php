...
class Comment_EweiShopV2Page extends AppMobilePage {
    ...
    function main() {
        ...
        $order = pdo_fetch("select id,status,iscomment from " . tablename('ewei_shop_order') . ' where id=:id and uniacid=:uniacid and openid=:openid limit 1'
        ...
        $goods = pdo_fetchall("select og.id,og.goodsid,og.price,g.title,g.thumb,og.total,g.credit,og.optionid,o.title as optiontitle from " . tablename('ewei_shop_order_goods') . " og "
