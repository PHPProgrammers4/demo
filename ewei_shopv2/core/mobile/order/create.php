...
//                pdo_update('ewei_shop_goods', array('sales' => $vgoods['sales'] + $vgoods['total']), array('id' => $vgoods['goodsid']));
    ...
    function caculatecard($card_id, $dispatch_price,$lotterydiscountprice,$taskcut,$goodsarr, $totalprice, $discountprice, $isdiscountprice,$liveid,$isSubmit = 0, $goods_dispatch = [])
    {
        global $_W;
        $open_redis = function_exists('redis') && !is_error(redis());
        $openid = $_W['openid'];
