...
class Coupon_EweiShopV2ComModel extends ComModel {
    ...
    function addtaskdata($orderid)
    {
        ...
        {
            $price = $order['price'];
            $sendtasks = pdo_fetch('select id,couponid,sendnum,num  from ' . tablename('ewei_shop_coupon_sendtasks') . '
