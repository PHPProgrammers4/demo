...
//    }
    ...
    $data = array(
        ...
        'type' => $goodstype,
        'ispresell' => intval($_GPC['ispresell']),                                  //  是否开启预售设置
        'presellover' => intval($_GPC['presellover']),                                  //  预售结束设置
        'presellovertime' => intval($_GPC['presellovertime']) > 0 ? intval($_GPC['presellovertime']) : 0,  //  预售结束X天后转为正常销售
        ...
        'presellsendtime' => intval($_GPC['presellsendtime']),                    //  预售购买后X天后发货
...
//      'discounts' => is_array($_GPC['discounts']) ? json_encode($_GPC['discounts']) : json_encode(array()),
    ...
    //show_json(0,array('isendtime'=>$data['isendtime'],'usetime'=>$data['usetime'],'endtime'=>$data['endtime']));
