        ...
        if ($condition != ' o.uniacid = :uniacid and o.ismr=0 and o.deleted=0 and o.isparent=0 ' || !empty($sqlcondition)){
            ...
            if ($searchfield == 'member') {
                ...
                if (!empty($openidArr)) {
                    ...
                    $orderPrice = pdo_fetch('SELECT COUNT(DISTINCT(o.id)) as count,sum(price) as sumprice FROM '.tablename('ewei_shop_order').' o WHERE o.uniacid = '.$_W['uniacid'].' AND o.deleted=0 AND o.isparent=0 AND o.openid IN ('.$inOpenid.')'.$timeCondition . $statuscondition) ;
                }else{
