...
--
-- 转存表中的数据 `ims_ewei_message_mass_sign`
--
...
--
-- 转存表中的数据 `ims_ewei_message_mass_task`
--
...
--
-- 转存表中的数据 `ims_ewei_message_mass_template`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_abonus_bill`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_abonus_billo`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_abonus_billp`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_abonus_level`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_area_config`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_article_comment`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_article_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_article_report`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_article_share`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_article_sys`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_author_bill`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_author_billo`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_author_billp`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_author_level`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_author_team`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_author_team_pay`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_bargain_actor`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_bargain_goods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_bargain_record`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_clearing`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_goods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_goods_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_operator`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_order`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_pay_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_pay_log_goods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_qrcode`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_cashier_user`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_city_express`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_commission_bank`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_commission_clickcount`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_commission_level`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_commission_rank`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_commission_repurchase`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_commission_shop`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_coupon_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_coupon_data`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_coupon_goodsendtask`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_coupon_guess`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_coupon_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_coupon_sendshow`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_coupon_sendtasks`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_coupon_taskdata`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_coupon_usesendtasks`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_creditshop_adv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_creditshop_comment`
--
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_creditshop_goods` (
  ...
  `maxpacketmoney` decimal(10,2) DEFAULT '0.00',
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_type` (`type`),
...
--
-- 转存表中的数据 `ims_ewei_shop_creditshop_goods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_creditshop_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_creditshop_option`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_creditshop_spec`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_creditshop_spec_item`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_creditshop_verify`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_customer`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_customer_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_customer_guestbook`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_customer_robot`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_datatransfer`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_designer`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_designer_menu`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_dispatch`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_diyform_data`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_diyform_temp`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_diypage_menu`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_diypage_plu`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_diypage_template_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exchange_cart`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exchange_code`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exchange_group`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exchange_query`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exchange_record`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exchange_setting`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exhelper_esheet_temp`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exhelper_express`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exhelper_senduser`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_exhelper_sys`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_express_cache`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_feedback`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_form_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_fullback_goods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_globonus_bill`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_globonus_billo`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_globonus_billp`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_globonus_level`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_goodscode_good`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_goods_cards`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_goods_comment`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_goods_group`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_goods_label`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_goods_labelstyle`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_groups_adv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_groups_goods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_groups_goods_atlas`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_groups_order`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_groups_order_refund`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_groups_paylog`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_groups_set`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_groups_verify`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_invitation`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_invitation_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_invitation_qr`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_live_adv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_live_coupon`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_live_favorite`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_live_goods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_live_goods_option`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_live_setting`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_live_status`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_live_view`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_lottery_default`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_lottery_join`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_lottery_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_mc_merchant`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_member_group`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_member_group_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_member_history`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_member_level`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_member_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_member_mergelog`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_member_message_template`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_member_message_template_default`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_member_rank`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_account`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_adv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_banner`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_bill`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_billo`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_category_swipe`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_clearing`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_group`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_nav`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_notice`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_perm_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_perm_role`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_reg`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_saler`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_store`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_merch_user`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_multi_shop`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_newstore_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_order_peerpay`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_order_peerpay_payinfo`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_order_print`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_order_refund`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_package_goods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_package_goods_option`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_pc_slide`
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6720 ;
...
(6714, 1, 1, '设置-短信提醒-短信模板库-添加', 'sysset.sms.temp.add', '添加短信模板 ID: 6 标题:  ', 1510558071, '42.202.172.232'),
(6715, 1, 1, '设置-短信提醒-短信模板库-删除', 'sysset.sms.temp.delete', '删除短信模板 id: 6  名称:验证码', 1510558196, '42.202.172.232'),
(6716, 1, 1, '小程序-基本设置-基本设置', 'app.setting.edit', '保存基本设置', 1516329090, '182.202.220.34'),
(6717, 1, 1, '小程序-基本设置-支付设置', 'app.setting.pay', '保存支付设置', 1516329090, '182.202.220.34'),
(6718, 1, 1, '小程序-基本设置-基本设置', 'app.setting.edit', '保存基本设置', 1516329912, '182.202.220.34'),
(6719, 1, 1, '小程序-基本设置-支付设置', 'app.setting.pay', '保存支付设置', 1516329912, '182.202.220.34');
...
--
-- 转存表中的数据 `ims_ewei_shop_perm_plugin`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_polyapi_key`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_postera_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_postera_qr`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_poster_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_poster_qr`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_poster_scan`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_qa_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_qa_question`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_quick_adv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_quick_cart`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_refund_address`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sale_coupon`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sale_coupon_data`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_seckill_adv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_seckill_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_seckill_task`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_seckill_task_goods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_seckill_task_room`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_seckill_task_time`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sendticket`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sendticket_draw`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sendticket_share`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sign_records`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sign_set`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sign_user`
--
...
INSERT INTO `ims_ewei_shop_sms_set` (`id`, `uniacid`, `juhe`, `juhe_key`, `dayu`, `dayu_key`, `dayu_secret`, `emay`, `emay_url`, `emay_sn`, `emay_pw`, `emay_sk`, `emay_phost`, `emay_pport`, `emay_puser`, `emay_ppw`, `emay_out`, `emay_outresp`, `emay_warn`, `emay_mobile`, `emay_warn_time`, `aliyun`, `aliyun_appcode`, `aliyun_new`, `aliyun_new_keyid`, `aliyun_new_keysecret`) VALUES
(3, 1, 0, '', 0, '', '', 0, '', '', '', '', '', 0, '', '', 0, 30, 0.00, '0', 0, 0, '1', 0, '', '');
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_board`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_board_follow`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_complain`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_complaincate`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_level`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_like`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_manage`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_member`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_sns_post`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_adv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_article`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_banner`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_case`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_casecategory`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_company_article`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_company_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_copyright`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_copyright_notice`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_guestbook`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_link`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_plugingrant_adv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_plugingrant_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_plugingrant_order`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_plugingrant_package`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_plugingrant_plugin`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_plugingrant_setting`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_setting`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_system_site`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_adv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_default`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_extension_join`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_join`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_joiner`
--
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_task_list` (
  ...
  `member_group` text,
  `auto_pick` tinyint(1) DEFAULT '0',
  `keyword_pick` varchar(20) DEFAULT '',
...
--
-- 转存表中的数据 `ims_ewei_shop_task_list`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_poster`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_poster_qr`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_record`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_task_reward`
--
...
(1, 0, '', '', '', '', '', '', '', '', 1, '../addons/ewei_shopv2/plugin/task/static/images/sky.png', 0);
...
--
-- 转存表中的数据 `ims_ewei_shop_task_type`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_verifygoods`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_verifygoods_log`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_virtual_category`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_virtual_data`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_virtual_type`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_wxapp_bind`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_wxapp_page`
--

INSERT INTO `ims_ewei_shop_wxapp_page` (`id`, `uniacid`, `type`, `name`, `data`, `createtime`, `lasttime`, `status`, `isdefault`) VALUES
(1, 1, 2, '商城首页', '', 1516328969, 1516328969, 1, 1);
...
--
-- 转存表中的数据 `ims_ewei_shop_wxapp_poster`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_wxapp_startadv`
--
...
--
-- 转存表中的数据 `ims_ewei_shop_wxapp_tmessage`
--
